...
def fvwmmenu(basedir, browsers):
   ...
   print("*FvwmForm-BrowserProfile: Input        profile        30  \"\"")
   print("*FvwmForm-BrowserProfile: Line         expand")
   print("*FvwmForm-BrowserProfile: Button       quit    \"Go\"   ^M")
   ##print("*FvwmForm-BrowserProfile: Command      \"LaunchWeb\" \"$(BRMProfile)\" \"keep\"")
   #print("*FvwmForm-BrowserProfile: Command      LaunchWeb test2 $profile $BROWSER")
   print("*FvwmForm-BrowserProfile: Command      Function LaunchWeb \"$BROWSER $(profile) keep\"")
   ...
   print()
   print("DestroyFunc BRM_NewProfile")
   print("AddToFunc BRM_NewProfile")
   print("+ I SetEnv Browser_new_type $0")
   print("+ I Echo $0")
   print("+ I Echo $[Browser_new_type]")
   print("+ I Module FvwmScript scripts/FvwmScript-BrowserInput")
   print()
   print("DestroyFunc BRM_StartNew")
   print("AddToFunc BRM_StartNew")
#   print("+ I Echo BRM_StartNew: $0")
#   print("+ I Echo BRM_StartNew: $[Browser_new_type]")
   print("+ I Function LaunchWeb $[Browser_new_type] $0 \"keep\"")
   #print("+ I Test (!StrMatch $[0] \"\") Echo $[Browser_new_type] $0 \"keep\"")
...
# This doesn't work, seems like a bug in fvwmform
#      print(f"+ \"New\" Module FvwmForm FvwmForm-BrowserProfile \"BROWSER={b.name}\"")
      #print("+ \"Newish\" Module FvwmScript scripts/FvwmScript-BrowserInput")
      print(f"+ \"New\" Function BRM_NewProfile {b.name}")
